    ...
    return <div className="container">
        ...
        <section>
            <p>
                ...
                I thrive on being challenged and enjoy collaborating with teams to deliver innovative solutions. My goal is to use my skills and knowledge to create efficient, scalable and user-friendly software applications.
            </p>
        </section>
        <br />
        <section>
